...
export const Products = [
  ...
  },
  {
    ...
    sold: 10500,
    category: 'Kecantikan',
    image: '/products/bioaqua-24k.png',
    isFlashSale: true,
    discount: '30%',
    stock: 'Tersedia',
    tag: 'Produk Viral',
