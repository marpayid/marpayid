        ...
        <div className="grid grid-cols-3 gap-3">
          {services.map((service) => {
            const content = (
              <div 
                className={cn(
                  "relative bg-white p-3 rounded-2xl border flex flex-col items-center justify-center gap-2 transition-all shadow-sm h-28 text-center overflow-hidden w-full",
                  service.active 
