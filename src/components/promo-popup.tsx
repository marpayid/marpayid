...
import { X, Gift, Sparkles, Zap, Ticket } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-500">
      <div className="relative w-full max-w-[340px] animate-in zoom-in-95 duration-500">
        ...
        {/* Main Card */}
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-white/20 text-white flex flex-col items-center text-center p-8">
          ...
          <div className="relative z-10 mb-6 flex flex-col items-center">
             <div className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-full border border-white/20 mb-4 animate-bounce">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-cyan-300 flex items-center gap-2">
                  <Sparkles className="w-3 h-3" /> PROMO SPESIAL
                </p>
             </div>
          ...
          <div className="relative z-10 space-y-2 mb-8">
             ...
             <div className="w-12 h-1 bg-yellow-400 mx-auto rounded-full opacity-50 my-3"></div>
          ...
          <div className="relative z-10 mb-8 w-full flex justify-center">
             <div className="relative animate-float">
                <div className="bg-white/10 backdrop-blur-xl p-6 rounded-[24px] border border-white/20 shadow-2xl relative overflow-hidden">
                   <Gift className="w-16 h-16 text-yellow-400 drop-shadow-[0_0_15px_rgba(250,204,21,0.5)]" />
          ...
          <div className="relative z-10 w-full pt-2">
             <Button 
               onClick={handleClaim}
               className="w-full bg-yellow-400 hover:bg-yellow-500 text-indigo-950 font-black h-14 rounded-2xl shadow-[0_10px_25px_rgba(250,204,21,0.3)] text-base uppercase tracking-tighter active:scale-95 transition-all"
             >
               AMBIL VOUCHER
             </Button>
             <p className="text-[9px] text-white/40 mt-4 uppercase font-bold tracking-widest">
